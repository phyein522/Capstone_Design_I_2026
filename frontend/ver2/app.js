  ...
  li.innerHTML = `
    ...
    <div class="masking-item-edit" style="display:none;">
      <div class="coord-grid">
        <label>x1: <input class="aero-input coord-input" type="text" inputmode="numeric" value="${x1}" data-coord="x1"></label>
        <label>y1: <input class="aero-input coord-input" type="text" inputmode="numeric" value="${y1}" data-coord="y1"></label>
        <label>x2: <input class="aero-input coord-input" type="text" inputmode="numeric" value="${x2}" data-coord="x2"></label>
        <label>y2: <input class="aero-input coord-input" type="text" inputmode="numeric" value="${y2}" data-coord="y2"></label>
      </div>
